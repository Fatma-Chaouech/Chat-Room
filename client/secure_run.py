...
class LoginPage(Tk):
    def __init__(self):
        ...
        self.side_image_label.place(x=280, y=20)
        ...
        self.sign_in_label.place(x=370, y=150)
        ...
        self.username_entry = Entry(self.window, highlightthickness=0, relief=FLAT,
                                    bg="#272727", fg="#6b6a69", font=("yu gothic ui ", 12, "bold"))
        self.username_entry.place(x=290, y=235, width=270)
        self.username_line = Canvas(
            self.window, width=300, height=2.0, bg="#bdb9b1", highlightthickness=0)
        self.username_line.place(x=260, y=259)

        # ===== Username icon =========
        self.username_icon = Image.open(
            relative_to_assets('username_icon.png'))
        photo = ImageTk.PhotoImage(self.username_icon)
        self.username_icon_label = Label(
            self.window, image=photo, bg='#272727')
        self.username_icon_label.image = photo
        self.username_icon_label.place(x=260, y=232)
        ...
        self.password_label = Label(self.window, text="Password", bg="#272727", fg="#4f4e4d",
                                    font=("yu gothic ui", 13, "bold"))
        self.password_label.place(x=260, y=280)
        self.password_entry = Entry(self.window, highlightthickness=0, relief=FLAT,
                                    bg="#272727", fg="#6b6a69", font=("yu gothic ui", 12, "bold"), show="*")
        self.password_entry.place(x=290, y=316, width=244)
        self.password_line = Canvas(
            self.window, width=300, height=2.0, bg="#bdb9b1", highlightthickness=0)
        self.password_line.place(x=260, y=340)
        ...
        self.lgn_button_label.place(x=285, y=380)
        self.login_ = Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold"),
                             width=25, bd=0, bg='#93D092', cursor='hand2', activebackground='#93D092', fg='white')
        self.login_.bind("<Button-1>", self.__login)
        self.login_.place(x=0, y=10)

        # ======== Password icon ================
        self.password_icon = Image.open(
            relative_to_assets('password_icon.png'))
        photo = ImageTk.PhotoImage(self.password_icon)
        self.password_icon_label = Label(
            self.window, image=photo, bg='#272727')
        self.password_icon_label.image = photo
        self.password_icon_label.place(x=260, y=314)
    ...
    def __login(self, _):
        ...
        self.channel.basic_consume(
            queue=username, on_message_callback=self.login_callback)
